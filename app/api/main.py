...
from app.retrieval.search import TOP_K, search
...
class QueryRequest(BaseModel):
    ...
    source_type: str | None = Field(
        default=None, description="Saring ke 'regulasi' atau 'faq' saja. Kosongkan untuk keduanya"
    )
    rerank: bool = Field(
        default=True,
...
def query(req: QueryRequest) -> QueryResponse:
    ...
    hits = search(req.question, limit=req.top_k, source_type=req.source_type, rerank=req.rerank)
    jawaban = jawab(req.question, hits)
